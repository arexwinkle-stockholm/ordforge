...
function startTraining() {
  ...
  const restPool = shuffle(state.deck.filter(c => !state.weak.includes(c)));
  const focus = [...state.weak, ...restPool.slice(0, Math.max(2, 6 - state.weak.length))];
